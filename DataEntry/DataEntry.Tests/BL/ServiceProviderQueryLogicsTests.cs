// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ServiceProviderQueryLogicsTests.cs" company="UDRI">
...
namespace DataEntry.Tests.BL
{
    ...
    /// </summary>
    [TestClass]
    public class ServiceProviderQueryLogicsTests
    {
        /// <summary>
        /// The target.
        /// </summary>
        private ServiceProviderQueryLogics target;
        ...
        [TestMethod]
        [TestCategory("ServiceProviderQueryLogicsTests")]
        public void ServiceProviderQueryTest()
        {
            using (ShimsContext.Create())
            {
                ShimServiceProviderRepo.AllInstances.GetServiceProvidersListOfInt32ListOfInt32 =
                    (repo, ints, arg3) => this.serviceProviderList;

                var response = this.target.ServiceProviderQuery(new List<int> { 1, 2 }, new List<int> { 1, 2 });
