// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VeteranProviderQueryLogicsTests.cs" company="UDRI">
...
namespace DataEntry.Tests.BL
{
    ...
    /// </summary>
    [TestClass]
    public class VeteranProviderQueryLogicsTests
    {
        /// <summary>
        /// The target.
        /// </summary>
        private VeteranProviderQueryLogics target;
        ...
        {
            this.target = new VeteranProviderQueryLogics();
        ...
        /// <summary>
        /// The veteran provider query test.
        /// </summary>
        [TestMethod]
        [TestCategory("VeteranProviderQueryLogicsTests")]
        public void VeteranProviderQueryTest()
        {
            using (ShimsContext.Create())
            {
                ShimVeteransRepo.AllInstances.GetServiceProvidersListOfInt32 = (repo, ints) => this.serviceProviderList;
