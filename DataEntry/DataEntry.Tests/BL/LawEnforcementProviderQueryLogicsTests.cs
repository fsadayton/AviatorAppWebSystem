// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LawEnforcementProviderQueryLogicsTests.cs" company="UDRI">
...
namespace DataEntry.Tests.BL
{
    ...
    /// </summary>
    [TestClass]
    public class LawEnforcementProviderQueryLogicsTests
    {
        /// <summary>
        /// The target.
        /// </summary>
        private LawEnforcementProviderQueryLogics target;
        ...
        [TestMethod]
        [TestCategory("LawEnforcementProviderQueryLogicsTests")]
        public void LawEnforcementProviderTest()
        {
            var test = this.target.ServiceProviderQuery(new List<int> { 57 });
            Assert.IsNotNull(test);
        }

        /// <summary>
        /// The Law Enforcement provider query test.
        /// </summary>
        [TestMethod]
        [TestCategory("LawEnforcementProviderQueryLogicsTests")]
        public void LawEnforcementProviderQueryTest()
        {
            using (ShimsContext.Create())
            {
                ShimLawEnforcementRepo.AllInstances.GetServiceProvidersListOfInt32 = (repo, ints) => this.serviceProviderList;
