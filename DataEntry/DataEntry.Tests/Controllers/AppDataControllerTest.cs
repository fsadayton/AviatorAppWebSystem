// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AppDataControllerTest.cs" company="UDRI">
...
namespace DataEntry.Tests.Controllers
{
    ...
    public class AppDataControllerTest
    {
        ...
        /// </summary>
        [TestMethod]
        [TestCategory("AppDataControllerTest")]
        public void GetServiceProvidersTest()
        {
            using (ShimsContext.Create())
            {
                ...
                var response = this.target.GetServiceProviders(new List<int> { 1, 2 }, new List<int> { 1, 2 });
