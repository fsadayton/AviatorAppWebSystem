// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AppVeteransControllerTest.cs" company="UDRI">
...
namespace DataEntry.Tests.Controllers
{
    ...
    /// </summary>
    [TestClass]
    public class AppLawEnforcementControllerTest
    {
        /// <summary>
        /// The target.
        /// </summary>
        ...
        /// <summary>
        /// The service provider query test.
        /// </summary>
        [TestMethod]
        [TestCategory("AppLawEnforcementControllerTest")]
        public void GetLawEnforcementProvidersTest()
        {
            using (ShimsContext.Create())
            {
                ShimLawEnforcementRepo.AllInstances.GetServiceProvidersListOfInt32 =
                    (repo, ints) => this.serviceProviderList;

                var response = this.target.GetLawEnforcementProviders(new List<int> { 1, 2 });
