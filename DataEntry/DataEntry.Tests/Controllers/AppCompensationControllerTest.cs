// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AppCompensationControllerTest.cs" company="UDRI">
...
namespace DataEntry.Tests.Controllers
{
    ...
    /// </summary>
    [TestClass]
    public class AppCompensationControllerTest
    {
        /// <summary>
        /// The target.
        /// </summary>
        ...
        /// </summary>
        [TestMethod]
        [TestCategory("AppCompensationControllerTest")]
        public void GetCompensationProvidersTest()
        {
            using (ShimsContext.Create())
            {
                ShimCompensationRepo.AllInstances.GetServiceProvidersListOfInt32 =
                    (repo, ints) => this.serviceProviderList;

                var response = this.target.GetCompensationProviders(new List<int> { 1, 2 });
