...
namespace DataEntry.Tests.Controllers
{
    ...
    /// </summary>
    [TestClass]
    public class AppVeteransControllerTest
    {
        /// <summary>
        /// The target.
        /// </summary>
        private AppVeteransController target;
        ...
        {
            this.target = new AppVeteransController();
        ...
        /// </summary>
        [TestMethod]
        [TestCategory("AppVeteransControllerTest")]
        public void GetVeteranProviderssTest()
        {
            using (ShimsContext.Create())
            {
                ...
                var response = this.target.GetVeteranProviders(new List<int> { 1, 2 });
