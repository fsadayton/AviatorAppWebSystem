...
var serviceProviderDisplay = (function () {
    ...
    function populatePage() {
        ...
        getFilterCategories();
        getCounties();
        getCategories(function () { getProviders(57) });
                ...
                for (var i = 0; i < providerList.length; i++) {
                    ...
                    for (var l = 0; l < provider.categories.length; l++) {
                        ...
                        if (providerCatName.name === filterCategories[j] && isInIncludedCategories === true) {
                            ...
                            var detailsUrl = getVeteranDetails + "/" + provider.serviceProviderId + "?location=" + provider.locationId;
